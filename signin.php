	...
	<body>
			...
			<div class="bgimage"> <!-- This is for background image -->
				...
				<form action="success_registered.php" method="POST">
					<div class="login_box">
						<h1>Registeration</h1> 
				<input type="text" name="id" placeholder="College ID" required="required" />

				<input type="text" name="name" placeholder="Surname  Firstname  Fathername  Mothername" required="required" />
